(function($){
	var bigColorPicker = new function(){
		...
		this.init = function(){
			/*$("body").append('<div id="bigpicker" class="bigpicker"><ul class="bigpicker-bgview-text" ><li><div id="bigBgshowDiv"></div></li><li><input id="bigHexColorText" size="7" maxlength="7" value="#000000" /></li><li><div>自动</div></li></ul><div id="bigSections" class="bigpicker-sections-color"></div><div id="bigLayout" class="biglayout" ></div></div>');*/
			$("body").append('<div id="bigpicker" class="bigpicker"><ul class="bigpicker-bgview-text"><li><div id="auto"></div></li><li><span class="text-left">auto</span></li><li><div id="defColor"></div></li><li><span class="text-left">default</span></li></ul><div id="bigSections" class="bigpicker-sections-color"></div><div id="bigLayout" class="biglayout" ></div></div>');
			...
			$("#auto").on("click", function(event) {
				invokeCallBack("#333333");
				$("#bigpicker").hide();
			});
			
			$("#defColor").on("click", function(event) {
				invokeCallBack($(currentPicker).data("defcolor"));
				$("#bigpicker").hide();
			});
		...
		this.showPicker = function(callback,engine,sideLength_){
			...
			$("#defColor").css("background-color", $(this).data("defcolor"));
			...
			if(engine == "L" ){
				...
				//预加载图片
			     ...
			     bgmage.src = "common/img/big_bgcolor.jpg";
			     //初始化为默认样式
			...
			$(this).one("mousemove", clickBtn).bind("click", clickBtn);
